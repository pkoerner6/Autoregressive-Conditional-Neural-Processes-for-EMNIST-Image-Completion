...
def construct_masks_context(x, y):
    ...
    return x, y, xt, mask_hare, mask_lynx, contexts


def predict_predprey():
    model = load_experiment()
    x, y = load_data()
    x, y, xt, mask_hare, mask_lynx, contexts = construct_masks_context(x, y)
    ...
    return mean, noiseless_samples, noisy_samples, x, y, xt, mask_hare, mask_lynx


def plot_results(mean, noiseless_samples, noisy_samples, x, y, xt, mask_hare, mask_lynx):
...
if __name__ == "__main__":
    mean, noiseless_samples, noisy_samples, x, y, xt, mask_hare, mask_lynx = predict_predprey()
    plot_results(mean, noiseless_samples, noisy_samples, x, y, xt, mask_hare, mask_lynx)
